...
// Mock data simulating a founder's calendar
// This will be replaced with real Feishu/Google Calendar API later
 ...
 */
function convertFeishuEvent(feishuEvent: FeishuEvent): CalendarEvent {
 ...
 * 设置从飞书导入的日程
 */
export function setImportedEvents(events: CalendarEvent[]): void {
 ...
 * 获取已导入的飞书日程
 */
export function getImportedEvents(): CalendarEvent[] {
 ...
 */
export async function syncCalendar(feishuEvents?: FeishuEvent[]): Promise<CalendarEvent[]> {
  // 模拟网络延迟
